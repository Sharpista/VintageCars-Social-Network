...
namespace TheSocialNetwork.WebApp.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public ActionResult Details(Guid id)
        {
         ...
         i       new Uri(WebApp.Properties.Settings.Default.PostWebApiBaseURI);
            ...
            //========================================
            var sessionId = Guid.Parse(Session["profileId"].ToString());

            ViewBag.Notifications = db.Notifications
                .Include(n => n.Sender)
                .Where(n => n.Recipient.Id == sessionId).ToList();
